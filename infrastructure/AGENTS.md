...
Applies to everything under `infrastructure/`.

See the repository root `AGENTS.md` for shared conventions (branching, environment model, cross-app integration contracts).
...
- **Never run the apply** without providing the output of plan and ask for user verification:
