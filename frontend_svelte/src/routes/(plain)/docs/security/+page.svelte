	...
	<section>
		...
		<ul>
			...
			<ul>
				...
				<li><em>Groups</em> for fine grained access control - can be linked to Office365 groups</li>
			</ul>
		</ul>
	</section>
</section>
	...
	<section>
		<ul>
			...
			<ul>
				...
				<li><em>Inherit</em> can be true or false to prevent inheritance from parent resources</li>
			</ul>
		</ul>
	</section>
</section>
