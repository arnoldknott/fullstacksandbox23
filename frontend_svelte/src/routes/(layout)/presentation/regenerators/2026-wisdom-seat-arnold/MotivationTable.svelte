...
<div class="grid h-fit grid-cols-6 gap-3 text-{color || 'primary'}">
	<div class="heading">Amotivation</div>
	<div class="heading col-span-4">Extrinsic</div>
	<div class="heading">Intrinsic</div>
	...
	<div class="heading flex flex-col">
		...
		<button
			class="btn shadow-outline title-large border-outline flex h-50 flex-col gap-1 rounded-4xl border-2 shadow-md"
	...
	<div class=" hidden">Dummy to trigger color event</div>
</div>
