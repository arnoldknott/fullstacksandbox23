...
export const actions: Actions = {
    ...
    submitFunctionWithCallBackAndApplyAction: async ( event ) => {
        // can also be `async ({ request }) => ...
        const data = await event.request.formData();
        console.log('=== playground - dataflow - +page.server.ts - submitFunctionWithCallbackAndApplyAction ===');
        console.log(data); // FormData object with the submitted form data
        // console.log(event)
        return {
    ...
    submitFunctionWithCallBackAndUpdate: async ( event ) => {
        // can also be `async ({ request }) => ...
        const data = await event.request.formData();
        console.log('=== playground - dataflow - +page.server.ts - submitFunctionWithCallbackAndUpdate ===');
        console.log(data); // FormData object with the submitted form data
        console.log(event)
