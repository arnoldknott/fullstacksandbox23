...
<div class="relative">
	...
	>
		<div class="drawer-body px-2 pt-4">
			<ul class="menu sticky p-0">
				<li>
					<a href="./stand-alone#loreum1">
						<span class="icon-[tabler--home] size-5"></span>
						Home
					</a>
				</li>
				<li>
					<a href="./stand-alone#loreum2">
