...
<Title id="drawer-with-title">Drawer with title</Title>
<Drawer id="with-title" title="Custom Drawer Title" />

<Title id="drawer-with-body">Drawer with body</Title>
<Drawer id="with-body" title="Drawer with Body">
