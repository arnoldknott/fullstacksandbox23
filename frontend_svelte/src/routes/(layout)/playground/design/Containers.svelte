<div class="flex flex-row">
	<div class="container grow">
		<div class="gap-4 rounded-xl border-2 border-outline-variant bg-primary-container p-4">
			...
			<button
				class="text-label-small md:text-label btn btn-primary btn-gradient mt-2 max-w-16 rounded-full bg-primary text-primary-content"
				>Ok</button
			>
			<button
				class="text-label-small md:text-label btn btn-secondary btn-gradient max-w-24 rounded-full text-secondary-content"
				>Cancel</button
			>
		</div>
	...
	<div class="container grow">
		<div class="gap-4 rounded-xl border-2 border-outline-variant bg-accent-container p-4">
			...
			<button
				class="text-label-small md:text-label btn btn-accent btn-gradient mt-2 max-w-16 rounded-full bg-accent text-accent-content"
				>Ok</button
			>
			<button
				class="text-label-small md:text-label btn-neutral btn btn-gradient max-w-24 rounded-full bg-neutral text-neutral-content"
				>Cancel</button
			>
		</div>
		<div class="p-4 text-right">
